 ...
 */
class FrontendTestDetail extends FrontendBaseBlock
{
	/**
	 * The record
	 *
	...
	private function getData()
	{
		...
		// get record
		$this->record = FrontendTestModel::get($this->URL->getParameter(0));
	...
	protected function parse()
	{
		 ...
		 * $this->header->addOpenGraphImage(FRONTEND_FILES_URL . '/test/images/source/' . $this->record['image']);
		 */
		...
		$this->header->addOpenGraphData('url', SITE_URL . FrontendNavigation::getURLForBlock('test', 'detail') . '/' . $this->record['url'], true);
