 ...
 */
class BackendTestAddCategory extends BackendBaseActionAdd
{
	/**
	 * Execute the action
	 */
	...
	private function loadForm()
	{
		...
		$this->meta->setURLCallback('BackendTestModel', 'getURLForCategory');
	}
	...
	private function validateForm()
	{
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				$item['sequence'] = BackendTestModel::getMaximumCategorySequence() + 1;

				// save the data
				$item['id'] = BackendTestModel::insertCategory($item);
