					...
					<td id="leftColumn">
							...
							<div class="box">
								...
								<div class="options">
									<p>
										{option:item.image}
											<img src="{$FRONTEND_FILES_URL}/test/image/{$image_size}/{$item.image}"/>
										{/option:item.image}
										{$fileImage} {$fileImageError}
									</p>
									<p>
										<label for="imageCaption">{$lblImageCaption|ucfirst}</label>
										{$txtImageCaption} {$txtImageCaptionError}
									</p>
								</div>
							</div>
